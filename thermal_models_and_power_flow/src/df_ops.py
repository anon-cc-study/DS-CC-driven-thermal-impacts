...
# Optional function to sample transformers for small test-runs (default runs all transformers)
...
# Optional function to sample top n loaded transformers for small test-runs (default runs all transformers)
